...
final class ColdcalllogUITests: XCTestCase {
    ...
    func testAddEntryFlow() throws {
        ...
        nameField.tap()
        nameField.typeText("UI Test Prospect")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Prospect"].waitForExistence(timeout: 2))
    }
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Coldcall Pro"].waitForExistence(timeout: 2))
    }
